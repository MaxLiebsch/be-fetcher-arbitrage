import { findCrawledProductByLink } from "../../services/db/util/crudCrawlDataProduct.js";
        ...
        if (infos.total === productLimit && !queue.idle()) {
          ...
          if (product.name && product.price && product.link) {
            ...
            if (existingProduct) {
              ...
              if (!ean_prop || ean_prop !== "missing" || ean_prop !== "found") {
              ...
              const result = await createOrUpdateCrawlDataProduct(salesDbName, {
                ...product,
              });
